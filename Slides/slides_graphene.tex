...
\scriptsize
\vspace{-5mm}
\begin{tcolorbox}[width=0.9\textwidth,height=0.32\textwidth,colback=DeepSkyBlue!20,notitle,colframe=DeepSkyBlue!20,colupper=DeepSkyBlue4]
\scriptsize
\vspace{-2mm}
\be
\hspace{-2mm}
t_r(\bm{\xi}) = \sum_{k=0}^{P} c_{k} \Psi_{k}(\bm{\xi}) \nonumber
\ee
\vspace{-2mm}
\tiny
\be \bm \xi: \{\xi_1(D_0),\xi_2(E_a),\xi_3(dT/dt),\xi_4(t_p)\} \nonumber \ee
\end{tcolorbox}
\end{center}
...
\begin{center}
\vspace{-3.4mm}
\begin{tcolorbox}[width=0.9\textwidth,height=0.38\textwidth,colback=DeepSkyBlue!20,notitle,colframe=DeepSkyBlue!20,colupper=DeepSkyBlue4]
\vspace{-5.5mm}
\scriptsize
\be
\begin{aligned}
